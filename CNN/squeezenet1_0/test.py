...
def test(test_loader, model, fold, ckpt, best_what, if_gen_txt,index):
    ...
    np.save(os.path.join(save_dir, "csv_0716_"+str(index)+"_"+best_what+".npy"), pred_csv_npy)
    if if_gen_txt:
...
def training(train_data_list, val_data_list, test_files, fold):
    ...
    for index in range(1,2):
        ...
        test(test_loader, model, fold, checkpoint_loss, 'best_loss', False,index)
        ...
        test(test_loader, model, fold, checkpoint_acc, 'best_acc', False,index)
