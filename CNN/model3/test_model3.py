...
def GeResult():
    ...
    net = MultiModalNet('se_resnet50', 'DPN26', 0.5)
    print("weights  model3_31")
    net.load_state_dict(torch.load('model3/BDXJTU2019_SGD_31_4000.pth'))
    ...
    import numpy as np
    f = open(filename, 'w')
    csv6_O=open("csvO[3_31].csv","w")
    csv6_H=open("csvH[3_31].csv","w")
